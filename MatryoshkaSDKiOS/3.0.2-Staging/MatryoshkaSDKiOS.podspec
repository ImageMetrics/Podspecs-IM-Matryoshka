...
LICENSE
  ...
  s.source = { :http => 'http:/nexus.apps.image-metrics.net/repository/pods-im-matryoshka/MatryoshkaSDKiOS-iOS-3.0.2-Staging+804.de2714e402ad.KioskTestingDoNotUse.zip'}
